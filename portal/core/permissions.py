...
class SessionPermissions(BasePermissionEnum):
    MANAGE_SESSIONS = "session.manage_sessions"


class InvestmentPermissions(BasePermissionEnum):
    MANAGE_INVESTMENTS = "investment.manage_investments"
