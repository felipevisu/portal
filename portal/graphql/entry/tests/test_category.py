...
def test_category_query_by_id(api_client, vehicle):
...
def test_category_query_invalid_id(api_client, vehicle):
    category_id = "'"
...
def test_category_query_object_with_given_id_does_not_exist(api_client, vehicle):
...
def test_category_query_by_slug(api_client, vehicle):
    category = Category.objects.first()
